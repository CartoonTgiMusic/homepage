    ...
    window.close()
        ...
        function createTrackItem(index,name,duration){
          ...
          function loadNewTrack(index){
            ...
            document.querySelector('.titles').innerHTML = listAudio[index].name+'<br>'+listAudio[index].duration
          ...
          document.querySelector('.titles').innerHTML = listAudio[indexAudio].name+"<br>"+listAudio[indexAudio].duration
